...
public class AutoPathRed extends OpMode {
    ...
    private static final float powershotSpeed=1350f;
    ...
    public void initTrajectories() {
        ...
        t_A_1 = drive.trajectoryBuilder(t_A_0.end())
                ...
                .splineToLinearHeading(new Pose2d(-42, -50, Math.toRadians(270)), Math.toRadians(270))
                .addDisplacementMarker(() -> {
                    drive.setWobbleArmPosition(grabberArmExtended);
                    releaseWobble();
                })
